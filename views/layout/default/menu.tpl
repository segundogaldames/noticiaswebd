<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a href="{$_layoutParams.root} " class="d-flex align-items-center text-dark text-decoration-none">
            <img src="{$_layoutParams.route_img}favicon_io/apple-touch-icon.png" alt="" width="40">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{$_layoutParams.root}nosotros">Nosotros</a>
                </li>
                ...
                {else}
                    <li class="nav-item">
                        <a href="{$_layoutParams.root}login/login" class="nav-link">Login</a>
                    </li>
